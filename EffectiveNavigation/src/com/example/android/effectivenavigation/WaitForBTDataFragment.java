 ...
 */
public class WaitForBTDataFragment extends Fragment {
    ...
    private static final String fragmentTag = WaitForBTDataFragment.class.getName();

    private String messageToShow = null;

    public static WaitForBTDataFragment newInstance (String message) {
        WaitForBTDataFragment fragment = new WaitForBTDataFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(fragmentTag,"create in WaitForBTDataFragment");
    }
    ...
    public void onResume() {
        super.onResume();
        Log.d(fragmentTag,"resume to WaitForBTDataFragment");
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.d(fragmentTag,"pause in WaitForBTDataFragment");
    }
